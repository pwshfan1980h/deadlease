...
const stages=['test','build','audit:assets','test:browser','test:noir','test:roaming','test:clinic','test:inventory','test:frontier','test:motion','test:boards','test:pause','test:theft','test:interactions','test:runs'];
